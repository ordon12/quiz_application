...
public class ResultAcitivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_result_acitivity2);
        ...
        sb4.append(QuestionActivity2.correct + "/"+ "5");
        ...
        btnRestart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(ResultAcitivity2.this, MainActivity.class);
